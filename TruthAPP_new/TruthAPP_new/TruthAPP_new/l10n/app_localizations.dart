...
abstract class S {
  ...
  /// No description provided for @deepfakeAlertTitle.
  ///
  /// In en, this message translates to:
  /// **'Deepfake Alert'**
  String get deepfakeAlertTitle;

  /// No description provided for @deepfakeAlertMessage.
  ///
  /// In en, this message translates to:
  /// **'Deepfake: do not believe unverified information.'**
  String get deepfakeAlertMessage;

  /// No description provided for @enableSocialVigil.
  ///
  /// In en, this message translates to:
  /// **'Enable Social Vigil'**
  String get enableSocialVigil;

  /// No description provided for @socialVigilDescription.
  ///
  /// In en, this message translates to:
  /// **'When enabled, Truth AI discreetly reminds you while using the selected social networks.'**
