...
class SAr extends S {
  ...
  @override
  String get deepfakeAlertTitle => 'تنبيه المحتوى المزيف';

  @override
  String get deepfakeAlertMessage =>
      'المحتوى المزيف: لا تصدق المعلومات غير المؤكدة.';

  @override
  String get enableSocialVigil => 'تفعيل المراقبة الاجتماعية';

  @override
  String get socialVigilDescription =>
      'عند التفعيل، يقوم Truth AI بتذكيرك بشكل غير ملحوظ أثناء استخدام شبكات التواصل الاجتماعي المحددة.';
}
