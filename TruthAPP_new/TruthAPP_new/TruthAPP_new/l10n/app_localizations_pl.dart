...
class SPl extends S {
  ...
  @override
  String get deepfakeAlertTitle => 'Ostrzeżenie o deepfake';

  @override
  String get deepfakeAlertMessage =>
      'Deepfake: nie wierz w niesprawdzone informacje.';

  @override
  String get enableSocialVigil => 'Włącz Społeczną Czujność';

  @override
  String get socialVigilDescription =>
      'Po włączeniu Truth AI będzie dyskretnie przypominać ci podczas korzystania z wybranych mediów społecznościowych.';
}
