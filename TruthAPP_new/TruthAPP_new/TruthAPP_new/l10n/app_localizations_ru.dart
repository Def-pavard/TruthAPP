...
class SRu extends S {
  ...
  @override
  String get deepfakeAlertTitle => 'Предупреждение о дипфейке';

  @override
  String get deepfakeAlertMessage =>
      'Дипфейк: не верьте непроверенной информации.';

  @override
  String get enableSocialVigil => 'Включить Социального Наблюдателя';

  @override
  String get socialVigilDescription =>
      'При активации Truth AI будет незаметно напоминать вам при использовании выбранных социальных сетей.';
}
