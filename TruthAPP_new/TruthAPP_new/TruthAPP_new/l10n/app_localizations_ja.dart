...
class SJa extends S {
  ...
  @override
  String get deepfakeAlertTitle => 'ディープフェイク警告';

  @override
  String get deepfakeAlertMessage => 'ディープフェイク：未確認の情報を信じないでください。';

  @override
  String get enableSocialVigil => 'ソーシャル監視を有効化';

  @override
  String get socialVigilDescription =>
      '有効にすると、Truth AI は選択したソーシャルメディアを使用する際にさりげなく注意を促します。';
}
