...
class SHe extends S {
  ...
  @override
  String get deepfakeAlertTitle => 'התראת דיפפייק';

  @override
  String get deepfakeAlertMessage => 'דיפפייק: אל תאמינו למידע לא מאומת.';

  @override
  String get enableSocialVigil => 'הפעל שמירת רשתות חברתיות';

  @override
  String get socialVigilDescription =>
      'כאשר מופעלת, Truth AI מזכירה לך בעדינות בעת שימוש ברשתות החברתיות שנבחרו.';
}
